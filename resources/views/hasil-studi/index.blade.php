                        ...
                        <tr class="bg-white border-b ">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-2 text-white">
                                    <a href="/hasil-studi/{{ $m->username }}" class="w-fit">
...
@section('bottom')
    ...
    <div class="modal">
        <div class="modal-box">
            <h3 class="font-bold text-lg mb-5">Import Hasil Studi</h3>
            <form action="/hasil-studi/import" method="POST" enctype="multipart/form-data">
