    ...
    <div class="p-5 min-h-screen">
        <div class="flex justify-between items-center flex-wrap">
            ...
            <div class="flex justify-end mb-3 gap-2">
                ...
                <a href="/presensi-dosen/cetak/{{ $tahun_ajaran->first()->kode_tahun_ajaran }}?bulan={{ date('m') }}"
                    target="_blank" class="btn btn-sm bg-green-500 text-white hover:bg-green-700 border-0">
                    BULAN INI
