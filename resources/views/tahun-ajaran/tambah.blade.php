    ...
    <div class="p-5 min-h-screen">
        <div class="flex justify-between items-center">
            <div class="flex gap-2 items-center text-gray-500  mb-3">
                ...
                <h1 class="font-bold text-2xl">Tambah Tahun Ajaran</h1>
            </div>
        </div>
        @if ($errors->any())
        ...
        <form action="" method="POST" class="mt-5">
            @csrf
            <div class="mb-6">
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Kode Tahun Ajaran</label>
                <input type="text" id="name" name="kode_tahun_ajaran"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5"
                    placeholder="ex. 23241, untuk Tahun Ajaran Ganjil 2023/2024">
            </div>
            <div class="mb-6">
                <label for="username" class="block mb-2 text-sm font-medium text-gray-900">Nama Tahun Ajaran</label>
                <input type="text" id="username" name="nama_tahun_ajaran"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5"
