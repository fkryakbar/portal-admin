<div class="p-4 bg-white drop-shadow h-full fixed w-[300px] z-[100] transition-all overflow-y-auto" x-show="open"
    ...
    <div class="mt-3 flex flex-col gap-2 font-semibold text-sm text-gray-600">
        ...
        <a href="/penilaian"
            class="p-3 rounded flex gap-2 items-center @if (Request::is('penilaian*')) bg-green-500 text-white @else hover:text-green-500 @endif">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd"
    ...
    <hr class="my-5">
    <a href="https://siamad.stitastbr.ac.id"
        class="p-3 rounded flex gap-2 items-center bg-amber-500 text-white sticky">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            <path fill-rule="evenodd"
